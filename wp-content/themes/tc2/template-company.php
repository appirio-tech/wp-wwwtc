                ...
                <div class="company-main">
                    ...
                    <div class="section clearfix part-two">
                        ...
                        <div class="infos-list">
                            ...
                            <div class="txt">
                                <span class="circle-gray"><?php echo $k+1; ?></span>
                    ...
                    <div class="section part-three">
                        <div class="txt-right">
                            ...
                            <a href="<?php echo $fields['company_study_button_url']; ?>" class="btn-blue width165"><?php echo $fields['company_study_button_label']; ?></a>
                        </div>
                    </div>
