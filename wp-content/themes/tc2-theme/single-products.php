            ...
            <div class="app-visual-design-contents">
                ...
                <div class="app-visual-main">
                    ...
                    <div class="friend-link-module">
                        ...
                        <?php if ( $fields['product_partners'][0]['client'] ) : ?>
                ...
                <div class="location-carousel">
                    <div class="carousel-module">
                        <div class="head-box">
                            <a href="<?php echo $fields['product_showcase'][0]['view_all_link'][0]['url']; ?>" target="<?php echo $fields['product_showcase'][0]['view_all_link'][0]['target_window']; ?>" class="link-blue"><?php echo $fields['product_showcase'][0]['view_all_link'][0]['label']; ?></a>
