            ...
            <div class="tab-contents tab-contents-overview">
                <div class="mobile-info-area info-area">
                    ...
                    <div class="mains">
                        ...
                        <a href="<?php echo $fields['sec1_button'][0]['url']; ?>" class="btn-blue"><?php echo $fields['sec1_button'][0]['label']; ?></a>
                ...
                <div class="web-info-area info-area">
                    ...
                    <div class="mains">
                        ...
                        <a href="<?php echo $fields['sec2_button'][0]['url']; ?>" class="btn-blue"><?php echo $fields['sec2_button'][0]['label']; ?></a>
                ...
                <div class="innovation-info-area info-area">
                    ...
                    <div class="mains">
                        ...
                        <a href="<?php echo $fields['sec3_button'][0]['url']; ?>" class="btn-blue"><?php echo $fields['sec3_button'][0]['label']; ?></a>
                ...
                <div class="algorithms-info-area info-area">
                    ...
                    <div class="mains">
                        ...
                        <a href="<?php echo $fields['sec4_button'][0]['url']; ?>" class="btn-blue"><?php echo $fields['sec4_button'][0]['label']; ?></a>
                ...
                <div class="contact-module contact-white-module">
                    <section class="section-contact">
                        <div class="container">
                            <div class="valign-middle">
                                <h2 class="titles more-top"><?php echo $fields['sec5_title']; ?></h2>
