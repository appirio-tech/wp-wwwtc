<?php
    /* Template Name: Mobile Application Page Template */
...
?>
    ...
    <div class="wrapper about-topcoder-page about-topcoder-contact-page">
        ...
        <div class="contents">
            <div class="tab-contents tab-contents-mobile-applications">
                   
                <div class="mobile-info-detail info-area">
                ...
                <div class="products-module ribbon blue-ribbon">
            ...
            <!-- end .tab-contents-mobile-applications -->
        </div>
        <!-- end .contents -->
