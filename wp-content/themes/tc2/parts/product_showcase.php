...
<div class="carousel-info">
    <div id="carousel-app" class="carousel slide" data-ride="carousel" data-interval="">
        <div class="carousel-slide">
            ...
            <ol class="carousel-indicators indicators dark-dot">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <?php
                    ...
                    while ( $query->have_posts() ) : 
                        ...
                        $showcase_ctr++; ?>
                <div class="item <?php echo $showcase_ctr==1 ? 'active' : ''; ?> example-img<?php echo $showcase_ctr; ?>" 
                        ...
                        <div class="container">
                            <div class="valign-middle">
                                <div class="boxs right">
                                    ...
                                    <a href="<?php echo $showcase_fields['product_showcase_view_button'][0]['url']; ?>" class="btn-blue btn-view"><?php echo $showcase_fields['product_showcase_view_button'][0]['label']; ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
