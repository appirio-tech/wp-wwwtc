<?php
    /* Template Name: Web Application Page Template */
...
?>
    ...
    <div class="wrapper about-topcoder-page about-topcoder-contact-page">
        ...
        <div class="top-banner-web-applications top-banner-what top-banner">
            <div class="container">
        ...
        <div class="contents">
            <div class="tab-contents tab-contents-web-applications">
                   
                <div class="web-info-detail info-area">
                    ...
                    <div class="mains">
                        ...
                        <a href="<?php echo $fields['sec1_button'][0]['url']; ?>" class="btn-blue btn-see-the-result"><?php echo $fields['sec1_button'][0]['label']; ?></a>
                    </div>
                    <!-- end .mains -->
                </div>
                <!-- end .mobile-info-detail -->
                
                <div class="products-module ribbon green-ribbon">
