		...
		<?php 
			...
			if ( ! empty( $categories ) ) {
				foreach( $categories as $category ) {
					$output .= '<li><a data-toggle="tab" class="category" href="#' . esc_html( $category->slug ) . '" alt="' . esc_attr( sprintf( __( 'View all posts in %s', 'textdomain' ), $category->name ) ) . '"><span class="font-lato">' . esc_html( $category->name ) . '</span></a></li>';
				}
