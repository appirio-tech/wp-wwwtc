<?php /* Template Name: Blog Customer Page*/
/**
...
<div class="tab-content">
	<?php 
        echo do_shortcode('[wp-tiles post_type="post" orderby="date" order="DESC" posts_per_page="auto" category="customer" tag="" tax_operator="IN" offset="0" post_status="publish" ignore_sticky_posts="false" exclude_current_post="true"]');
    /*
	$count = 1;
	if ( ! empty( $categories ) ) {
	foreach( $categories as $category ) { ?>
